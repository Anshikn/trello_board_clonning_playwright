...
def run():
    with sync_playwright() as p:
        ...
        # Click sidebar Add button and then Labels
        ...
        with open("search_new_label_popover.html", "w") as f:
            f.write(html)
        page.screenshot(path="search_new_label_view.png")
        print("Successfully dumped search label view.")
        browser.close()
